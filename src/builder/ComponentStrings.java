...
public class ComponentStrings {
    ...
    public static final String ON_ANSWER = "{() => { setIsLocked%d(false) }}";
    ...
    public static final String RESEARCH_QUESTION = "ResearchQuestion";
    ...
    public static final String FILL_QUESTION = "FillQuestion";
